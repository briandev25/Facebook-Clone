    ...
    <div className='flex justify-between items-center sticky top-0 z-50 shadow-md p-2 xl:px-5 bg-white'>
        ...
        <div className='flex'>
            ...
            <div className=' flex border rounded-full ml-2 px-2 py-1 items-center cursor-pointer bg-gray-100'>
                ...
                <input type='text' placeholder='Search Facebook' className=' outline-none bg-transparent hidden lg:block' />
            </div>
        </div>
        {/* center */}
        ...
        <div className='flex items-center'>
            <div className='hidden xl:inline-block'>
                {/* Profile Image Here */}
                 ...
                 <p className=' font-semibold text-sm pr-3 whitespace-nowrap'>@briandev25</p>
            </div>
